...
public class EightBitAvatar {
  ...
  public static ElementRegistry newMaleElementRegistry() {
    ...
    for (EightMaleElementType eightMaleElementType : EightMaleElementType.values()) {
      elementRegistry.putElement(
          eightMaleElementType.name(),
          URLElementRegistry.lsPngURLs(
              EightBitAvatar.class.getClassLoader(), eightMaleElementType.path));
    }

    elementRegistry.putGroup(
        ElementInfo.of(EightMaleElementType.background.name()),
  ...
  public static ElementRegistry newFemaleElementRegistry() {
    ...
    for (EightFemaleElementType eightFemaleElementType : EightFemaleElementType.values()) {
      elementRegistry.putElement(
          eightFemaleElementType.name(),
          URLElementRegistry.lsPngURLs(
              EightBitAvatar.class.getClassLoader(), eightFemaleElementType.path));
    }

    elementRegistry.putGroup(
        ElementInfo.of(EightFemaleElementType.background.name()),
