...
public class Avatar {
        ...
        for (ElementInfo element : elements) {
          ...
          if (elementCount > 0) {
            ...
            BufferedImage bufferedImage =
                AvatarUtils.toARGBImage(
                    elementRegistry.getElement(avatarInfo, element.name, index));
            ...
            imageInfos.add(
                new ImageInfo(element.name, bufferedImage, element.offsetX, element.offsetY));
          }
        }
      }
    }
  ...
  private void copyImage(
      Graphics2D g2, IAvatarInfo avatarInfo, ImageInfo imageInfo, int width, int height)
      throws IOException {
  ...
  public static class AvatarBuilder {
    ...
    /** Set size of avatar Default is 128x128 */
    ...
    /** Set space with border Default is 8 */
    public AvatarBuilder padding(int padding) {
      this.padding = padding;
      return this;
    }

    /** Set space out border Default is 8 */
