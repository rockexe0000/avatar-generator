  ...
  public static ElementRegistry newElementRegistry() {
    ...
    for (CatElementType catElementType : CatElementType.values()) {
      elementRegistry.putElement(
          catElementType.name(),
          URLElementRegistry.lsPngURLs(CatAvatar.class.getClassLoader(), catElementType.path));
    }

    elementRegistry.putGroup(
        ElementInfo.of(CatElementType.body.name()),
        ElementInfo.of(CatElementType.fur.name()),
    ...
    elementRegistry.putGroup(
        ...
        ElementInfo.of(CatElementType.eyes.name()),
        ElementInfo.of(CatElementType.mouth.name()),
        ElementInfo.of(CatElementType.zz.name()));
